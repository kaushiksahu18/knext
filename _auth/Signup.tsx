...
export function SignupForm() {
  ...
  return (
    <div className="z-[99] max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <h2 className="font-bold text-xl text-neutral-200">Welcome to Pikapo</h2>
